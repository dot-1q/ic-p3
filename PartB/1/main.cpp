...
int main(void){
    ...
    Lang lang  = Lang(6, 0.03f, "../2/Textos/Portugese_latn_EP7.utf8", filename);
    Lang lang2 = Lang(6, 0.03f, "../2/Textos/French_latn_EP7.utf8", filename);
    Lang lang3 = Lang(6, 0.03f, "../2/Textos/Spanish_latn_EP7.utf8", filename);
    Lang lang4 = Lang(6, 0.03f, "../2/Textos/Italian_latn_EP7.utf8", filename);
